...
import WavesWithdrawModal from "./WavesWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import WavesDepositAddressCache from "lib/common/WavesDepositAddressCache";
import {requestDepositAddress} from "lib/common/WavesMethods";
...
class WavesGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new WavesDepositAddressCache();
...
export default BindToChainState(WavesGatewayDepositRequest, {
    keep_updating: true
});
