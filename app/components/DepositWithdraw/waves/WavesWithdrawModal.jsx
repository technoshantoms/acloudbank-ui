...
import {validateAddress, WithdrawAddresses} from "common/WavesMethods";
...
class WavesWithdrawModal extends React.Component {
    static propTypes = {
...
WavesWithdrawModal = BindToChainState(WavesWithdrawModal);

export default connect(WavesWithdrawModal, {
    listenTo() {
