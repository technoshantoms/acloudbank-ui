...
class BscDepositAddressCache {
    constructor() {
        // increment this to force generating new addresses for all mappings
        this.current_bsc_address_cache_version_string = "1";
    }
    ...
    getIndexForDepositKeyInExchange(
        ...
        let args = [
            this.current_bsc_address_cache_version_string,
            account_name,
            input_coin_type,
            output_coin_type
        ];
...
export default BscDepositAddressCache;
