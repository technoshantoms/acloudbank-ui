...
import BscGatewayDepositRequest from "./BscGatewayDepositRequest";
...
class BscGateway extends React.Component {
    constructor(props) {
        super();
...
export default connect(BscGateway, {
    listenTo() {
