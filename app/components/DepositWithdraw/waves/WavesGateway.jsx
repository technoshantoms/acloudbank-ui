...
import WavesGatewayDepositRequest from "./WavesGatewayDepositRequest";
...
class WavesGateway extends React.Component {
    constructor(props) {
        super();

        this.state = {
            activeCoin: this._getActiveCoin(props, {action: "deposit"}),
            action: props.viewSettings.get("wavesAction", "deposit")
        };
    }

    _getActiveCoin(props, state) {
        let cachedCoin = props.viewSettings.get(
            `activeCoin_waves_${state.action}`,
            null
        );
        let firstTimeCoin = null;
        if (state.action === "deposit") {
            firstTimeCoin = "XBTSX.WAVES";
        }
    ...
    onSelectCoin(e) {
        ...
        let setting = {};
        setting[`activeCoin_waves_${this.state.action}`] = e.target.value;
    ...
    changeAction(type) {
        ...
        SettingsActions.changeViewSetting({["wavesAction"]: type});
    }
...
export default connect(WavesGateway, {
    listenTo() {
